...
public class GlobalExceptionHandler {
    ...
    private ApiRestResponse handleBindingResult(BindingResult result){
        ...
        if(list.size() == 0){
            return ApiRestResponse.error(FreshMallExceptionEnum.REQUST_PARA_ERROR);
        }
        return ApiRestResponse.error(FreshMallExceptionEnum.REQUST_PARA_ERROR.getCode(),list.toString());
    }
}
